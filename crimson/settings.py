...
DATATYPE_LOCATIONS.append("crimson.datatypes")
FUNCTION_LOCATIONS.append("crimson.functions")
ETL_MODULE_LOCATIONS.append("crimson.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("crimson.search_components")
...
SECRET_KEY = "django-insecure-1v5%2a^#odg*kh7p)8^&!css&faj^u2j+x*ubly%i-jhf545od"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "crimson.urls"
ROOT_HOSTCONF = "crimson.hosts"

DEFAULT_HOST = "crimson"
...
ELASTICSEARCH_PREFIX = "crimson"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'crimson.search_indexes.sample_index.SampleIndex',
